...
public class MainClass {
	...
	public MainClass() {
		Frame frame = new Frame("5HC99 - Embedded Visual Control - PointCloud Viewer");
        ...
        icpUDP.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
            	icpUDPCheckboxActionPerformed(evt);
            }
        });
        
        labelCheckbox = new JLabel("ICP");
        labelCheckbox.setForeground(Color.white);
        checkbox.add(icpUDP);
        checkbox.add(labelCheckbox);
	...
	private void icpUDPCheckboxActionPerformed(java.awt.event.ActionEvent evt) {
	    //labelFILE.setText("test");
		if(icpUDP.isSelected()) {
			udp.setICPRun(true);
		} else {
			udp.setICPRun(false);
		}
